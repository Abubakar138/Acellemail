                    ...
                    <span class="template-image-box2">
                        ...
                        <div class="preview_control">
                            <div style="width: calc(80% - 0px);">
                                <div class="mb-2">
                                    <a class="btn btn-light d-block form-popup-preview" href="{{ action('Admin\FormTemplateController@preview', $template->uid) }}" oxnclick="popupwindow('{{ action('Admin\TemplateController@preview', $template->uid) }}', `{{ $template->name }}`, 800, 320)"><span class="material-symbols-rounded">zoom_in</span> {{ trans("messages.preview") }}</a>
                                </div>
                                <div>
                                    <div>
                                ...
                                @if (Auth::user()->admin->can('preview', $template) ||
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            @endif
                                            @if (Auth::user()->admin->can('preview', $template))
                                                <li><a class="dropdown-item form-popup-preview" href="{{ action('Admin\FormTemplateController@preview', $template->uid) }}"><span class="material-symbols-rounded">zoom_in</span> {{ trans("messages.preview") }}</a></li>
                                            @endif
                                            @if (Auth::user()->admin->can('update', $template))
                                                <li>
