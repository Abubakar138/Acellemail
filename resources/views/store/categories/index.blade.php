...
@section('title', trans('store.categories'))
...
@section('page_header')
    ...
    @include('store.helpers.page_header', [
                ...
                'link' => action('Store\CategoryController@create',[ 'page' => request()->page, ]),
                'link_title' => trans('store.categories.add_new'),
            ]) 
@endsection 
...
<div id="FunnelList" class=""> 
    <div class="d-flex align-items-center mb-3">
        ...
        <form id="smsFunnel" name="smsFunnel" action="{{ action('Store\CategoryController@index',[ 'page' => request()->page,]) }}" method="POST">
            {{ csrf_field() }}
            @method('PUT')
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a list-control="delete-selected-button"
                                        href="{{ action('Store\CategoryController@deleteSelected') }}"
                                ...
                                <li>
                                    ...
                                    class="dropdown-item" href="{{ action('Store\CategoryController@multiltask') }}">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item status-link ftext-capitalize <?php echo (isset(request()->status)? '':'active') ?>" 
                                        ...
                                        filter-by ="all"
                                        href="{{ action('Store\CategoryController@index',[ 
                                            'status'=> 'all',
                                            'type'=> request()->type,
                                            'page' => request()->page,
        ...
        <div class="mt-2 mt-sm-0 ms-sm-auto">
            <div class="d-flex">
                <div class="mr-2">
                    <a class="ftext-capitalize btn-lg" style="font-size: 20px;" href="{{ action('Store\CategoryController@index',['view' => 'grid']) }}">
                        <span class="material-symbols-rounded">grid_view</span>
                    </a>  
                </div>
                <div class="mr-2">
                    <a class="ftext-capitalize btn-lg" style="font-size: 25px;" href="{{ action('Store\CategoryController@index') }}">
...
<script>
    ...
    var FunnelIndex = {
        init: function() {
            ...
            this.funnelList = new DataList({
                ...
                url: '{{ action('Store\CategoryController@list') }}', 
    ...
    var DataList = class {
        ...
        */ 
        ...
        setStatus( status ) {
            this.status = status;
            this.url = '{{ action('Store\CategoryController@list') }}';
        }               
            ...
            this.getStatusInput().forEach(button => {  
                button.addEventListener('change', function(e) {
                    ...
                    $.ajax({
                        type: "PATCH",
                        dataType: "json",
                        url: '{{ action('Store\CategoryController@updateStatus') }}',
