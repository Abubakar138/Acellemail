<div class="row mt-5 pt-5">
    <div class="col-md-3">
        <div class="bg-color6 p-3 shadow rounded-3 text-white">
            <div class="text-center">
                <h2 class="text-semibold mb-1 mt-0">{{ $email->uniqueOpenCount() }}</h2>
    ...
    <div class="col-md-3">
        <div class="bg-color7 p-3 shadow rounded-3 text-white">
            <div class="text-center">
                <h2 class="text-semibold mb-1 mt-0">{{ $email->clickCount() }}</h2>
    ...
    <div class="col-md-3">
        <div class="bg-secondary p-3 shadow rounded-3 text-white">
            <div class="text-center">
                <h2 class="text-semibold mb-1 mt-0">{{ $email->bounceCount() }}</h2>
    ...
    <div class="col-md-3">
        <div class="bg-secondary p-3 shadow rounded-3 text-white">
            <div class="text-center">
                <h2 class="text-semibold mb-1 mt-0">{{ $email->unsubscribeCount() }}</h2>
