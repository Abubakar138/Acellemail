    ...
    <div class="col-md-6">
        ...
        @else
            <div class="stat-table">
                @foreach ($email->topClickCountries(7)->get() as $location)
                    <div class="stat-row">
    ...
    <div class="col-md-6">
        @if ($email->clickCount())
                ...
                <div class="">
                    <div class="chart-container has-scroll">
                        <div class="chart has-fixed-height"
                            ...
                            data-url="{{ action('CampaignController@chartClickCountry', $email->uid) }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <script>
                ...
                var ClickPieChart = {
                    url: '{{ action('CampaignController@chartClickCountry', $email->uid) }}',
                    getChart: function() {
