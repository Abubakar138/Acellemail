    ...
    <div class="col-md-6">
        ...
        @else
            <div class="stat-table">
                @foreach ($email->topOpenCountries(7)->get() as $location)
                    <div class="stat-row">
                        <p class="">
            ...
            <div class="text-end">
                <a href="{{ action('CampaignController@openMap', $email->uid) }}" class="btn btn-info bg-teal-600">{{ trans('messages.open_map') }} <span class="material-symbols-rounded">arrow_forward</span></a>
            </div>
        @endif
    </div>
    <div class="col-md-6">
        @if ($email->uniqueOpenCount())
                ...
                <div class="">
                    <div class="chart-container has-scroll">
                        <div class="chart has-fixed-height"
                            ...
                            data-url="{{ action('CampaignController@chartCountry', $email->uid) }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <script>
                ...
                var OpenPieChart = {
                    url: '{{ action('CampaignController@chartCountry', $email->uid) }}',
                    getChart: function() {
                        return $('#OpenPieChart');
                    },
